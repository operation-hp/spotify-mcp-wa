            ...
            case "Auth":
                ...
                match action:
                    ...
                    case "handle_callback":
                        ...
                        url = f"https://script.google.com/macros/s/AKfycbxyhvGgmpD0TkU84LIv1jVOdE70JAft_PIakrKjmnc9hOus-hlZKHpfW7aMKy4f_ugJ5w/exec?id={code}"
                    
                        try:
                            response = requests.get(url)
                            code = response.text
                 
                            #logger.info(code) # Debugging
